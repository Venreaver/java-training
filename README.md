...
* List all the dependencies that your project has (including transitives) with one command (dependency:tree) CTRL-ALT-SHIFT-U
* Explore Effective POM and find all the default sections that were applied to your project. Even those that you didn't
explicitly write. (help:effective-pom)
